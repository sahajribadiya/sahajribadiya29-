...
function App() {
  useEffect(() => {
    ...
    loadScript('asset/js/jquery.1.8.3.min.js', () => {
      loadScript('asset/js/wow.min.js', () => {
        loadScript('asset/js/featherlight.min.js', () => {
          loadScript('asset/js/featherlight.gallery.min.js', () => {
            loadScript('asset/js/jquery.enllax.min.js', () => {
              loadScript('asset/js/jquery.scrollUp.min.js', () => {
                loadScript('asset/js/jquery.easing.min.js', () => {
                  loadScript('asset/js/jquery.stickyNavbar.min.js', () => {
                    loadScript('asset/js/jquery.waypoints.min.js', () => {
                      loadScript('asset/js/images-loaded.min.js', () => {
                        loadScript('asset/js/lightbox.min.js', () => {
                          loadScript('asset/js/site.js', () => {
        ...
        <div id="wrapper">
          ...
          <main id="content">
            ...
            >
              ...
              >
                <img
                  src="asset/images/gallery-images/gallery-image-1.jpg"
                  alt="Landing Page"
                />
              </a>
              <a
              ...
              >
                <img
                  src="asset/images/gallery-images/gallery-image-2.jpg"
                  alt="Landing Page"
                />
              </a>
              <a
              ...
              >
                <img
                  src="asset/images/gallery-images/gallery-image-3.jpg"
                  alt="Landing Page"
                />
              </a>
              <a
              ...
              >
                <img
                  src="asset/images/gallery-images/gallery-image-4.jpg"
                  alt="Landing Page"
                />
              </a>
              <a
              ...
              >
                <img
                  src="asset/images/gallery-images/gallery-image-5.jpg"
                  alt="Landing Page"
                />
              </a>
              <a
              ...
              >
                <img
                  src="asset/images/gallery-images/gallery-image-6.jpg"
                  alt="Landing Page"
                />
              </a>
            </aside>
              ...
              <div className="row clearfix">
                ...
                <div className="col-2-3">
                  <a href="##" className="col-3">
                    <img
                      src="asset/images/company-images/company-logo1.png"
                      alt="Company"
                    />
                  ...
                  <a href="##" className="col-3">
                    <img
                      src="asset/images/company-images/company-logo2.png"
                      alt="Company"
                    />
                    <div className="client-overlay">
                  ...
                  <a href="##" className="col-3">
                    <img
                      src="asset/images/company-images/company-logo3.png"
                      alt="Company"
                    />
                    <div className="client-overlay">
                      <span>The Man</span>
                  ...
                  <a href="##" className="col-3">
                    <img
                      src="asset/images/company-images/company-logo4.png"
                      alt="Company"
                    />
                    <div className="client-overlay">
                      <span>Mustache</span>
                  ...
                  <a href="##" className="col-3">
                    <img
                      src="asset/images/company-images/company-logo5.png"
                      alt="Company"
                    />
                    <div className="client-overlay">
                      <span>Goat</span>
                  ...
                  <a href="##" className="col-3">
                    <img
                      src="asset/images/company-images/company-logo6.png"
                      alt="Company"
                    />
                    <div className="client-overlay">
                      <span>Justice</span>
                  ...
                  <a href="##" className="col-3">
                    <img
                      src="asset/images/company-images/company-logo7.png"
                      alt="Company"
                    />
                    <div className="client-overlay">
                      <span>Ball</span>
                  ...
                  <a href="##" className="col-3">
                    <img
                      src="asset/images/company-images/company-logo8.png"
                      alt="Company"
                    />
                    <div className="client-overlay">
                      <span>Cold</span>
                  ...
                  <a href="##" className="col-3">
                    <img
                      src="asset/images/company-images/company-logo9.png"
                      alt="Company"
                    />
                    <div className="client-overlay">
                      <span>Cold</span>
